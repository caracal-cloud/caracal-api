...
urlpatterns = [
    ...
    path('get_calls/', jackal.GetCallsView.as_view()), # new 
    path('get_contacts/', jackal.GetContactsView.as_view()), # new 
    path('get_locations/', jackal.GetLocationsView.as_view()), # new
    ...
    path('get_texts/', jackal.GetTextsView.as_view()), # new
